...
export function Footer() {
  return (
    <footer className="bg-surface pt-24 pb-12 px-6 border-t border-border">
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex gap-4">
              <Link
                ...
                className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:bg-primary hover:text-white transition-all"
              >
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li><Link href="/services" className="text-foreground/60 hover:text-primary transition-colors">Makeup Artists</Link></li>
              <li><Link href="/services" className="text-foreground/60 hover:text-primary transition-colors">Hair Stylists</Link></li>
              <li><Link href="/portfolio" className="text-foreground/60 hover:text-primary transition-colors">Portfolios</Link></li>
        ...
        <div className="pt-8 border-t border-border text-center">
          <p className="text-foreground/20 text-xs uppercase tracking-[0.2em]">
